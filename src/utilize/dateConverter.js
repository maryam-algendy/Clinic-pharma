...
export default function dateConverter(date, monthType = "string") {
    ...
    return monthType === "numeric" ? time.getUTCMonth().toString().length === 1 ? day + " - 0" + (time.getUTCMonth()) + " - " + year : day + " - " + (time.getUTCMonth()) + " - " + year : day.toString().length === 1 ? "0" + day + " - " + month + " - " + year : day + " - " + month + " - " + year;
}
